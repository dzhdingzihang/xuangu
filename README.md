...
- **A 股全量评分**：全部有效行情候选先完成基础评分和技术评分，300 只技术候选都可进入 Shadow 概率研究排序；再从技术数据完整且可交易的候选中选择最多 96 只运行 Legacy、V2、双低、Chan/CZSC、Serenity、UZI 与评审团深研。未深研候选不会伪造 Legacy 分数，也不能进入正式执行门禁。
