...
- **两周收益机会优先展示**：对本轮完整评分池独立排序，重点看 5/10/20 日趋势、同市场相对强弱、动量加速、量价结构、行业共振和去重后的事件证据；高波动不会仅因超过旧稳健规则的下行阈值就失去研究资格。首页先展示机会研究榜，再展示原稳健规则候选。研究分不是预期收益率，排名也不承诺未来获利最高。
...
| 组成 | 权重 | 依据 |
|---|---:|---|
| 多周期动量 | 30% | 真实 5/10/20 日涨幅，同时考虑风险标准化趋势 |
