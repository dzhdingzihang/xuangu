...
- 港股：恒指/恒科/港股常见科技权重 + AI 软件、AI 医疗、半导体设备、先进封装、数据中心、机器人、机器视觉等扩展池，当前静态候选池约 153 只。
- 美股：Nasdaq/S&P 科技大票 + AI 芯片、EDA、先进封装、AI 服务器、AI 网络、数据中心电力/液冷、neocloud、机器人、AI 软件、量子、商业航天等扩展池，当前静态候选池约 258 只。
